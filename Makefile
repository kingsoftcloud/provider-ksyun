...
PROJECT_NAME ?= provider-ksyun
PROJECT_REPO ?= github.com/kingsoftcloud/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-ksyun_v1.9.0
...
xpkg.build.provider-ksyun: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/ksyuns/01-delete.yaml.tmpl.
